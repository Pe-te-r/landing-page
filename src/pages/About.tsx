    ...
    return (
      <div className="bg-base-200 py-12">
        <div className="container mx-auto px-6 text-center md:px-12 lg:px-24 xl:px-48">
          <h2 className="text-4xl font-bold text-white-800 mb-8">About Us</h2>
          ...
          <h3 className="text-2xl font-semibold text-white-800 mb-4">Our History</h3>
          ...
          <h3 className="text-2xl font-semibold text-white-800 mb-4">Why Choose Us?</h3>
          <ul className="list-disc list-inside text-left text-white-700 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-white-800 mb-4">Our Mission</h3>
          <p className="text-white-700 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-white-800 mb-4">Our Vision</h3>
          <p className="text-white-700 mb-6">
          ...
          <h3 className="text-2xl font-semibold text-white-800 mb-4">Meet Our Team</h3>
          <p className="text-white-700 mb-6">
